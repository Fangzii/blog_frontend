    ...
    <div>
      <a-row :gutter="24">
        <a-col :xl="16" :lg="24" :md="24" :sm="24" :xs="24">
         <blogList :data="blogListData"></blogList>
        </a-col>
        <a-col
...
import { getUserList, getServiceList, getUserInformatization } from '@/api/manage'
  ...
  created () {
    ...
    getUserList().then(res => {
      for(let i in res.results) {
        let e = res.results[i]
        e.time = moment(e.created_at).startOf('day').fromNow();
